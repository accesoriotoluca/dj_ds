...
& para hacer pruebas puedo hacer un modelo:
& Creo que no necesita un campo en especial.
& simplemente con importar los signal existentes
& investigar los parámetros que manejan
& ver los datos que arrojan
& preguntar a chat x datos que no reconozca
! las señales parecen ser como código predefinido para intercepta comunicación interna entre apps/models q entrega info y correspondiente a esa info se puede configurar un todo o accion """
